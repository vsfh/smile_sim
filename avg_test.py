...
if __name__ == '__main__':
    ...
    up_net = alignModel('./weights/up_teeth_encoder/version_6/01000.pkl',
                        '/home/vsfh/training/less_cgan/down/500000.pt', 'up')
    ...
    base_path = '/home/vsfh/dataset/test_case/in'
    ...
    for file in flist:
        ...
        cv2.imwrite(f'./seg_test/{file}', cv2.cvtColor(mouth, cv2.COLOR_BGR2RGB))
        continue
